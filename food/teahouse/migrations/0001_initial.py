# Generated by Django 4.0.4 on 2022-04-13 20:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional', models.ManyToManyField(blank=True, related_name='additional_from', to='teahouse.food', verbose_name='Дополнительные товары')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='food', to='teahouse.foodcategory', verbose_name='Раздел меню')),
            ],
            options={
